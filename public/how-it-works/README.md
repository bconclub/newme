...
**Used by:** /how-it-works page — hero, section diagrams, conditions card images, comparison illustrations.

## How to add an image
1. Drop the file in this folder (recommended naming: `hero.webp`, `section-{name}.webp`, etc.)
2. Reference it in code as `/how-it-works/{filename}` — e.g. `<Image src="/how-it-works/hero.webp" />`
