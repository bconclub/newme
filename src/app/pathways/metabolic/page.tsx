...
const PHASES: Phase[] = [
  {
    ...
    careItems: [
      ...
      { num: '04', title: 'Movement Readiness & Activity Support', desc: 'Fitness screening by a Physical therapist, step goals, and beginner movement routines to safely build activity.' },
    ...
    bannerImg: '/pathways/Pathways%20Small%20Banner%201.webp',
    bannerHeading: 'Who Is Prescribed The RESET Pathway?',
    bannerBody: 'RESET is best suited for clients who need to stabilize the body and establish consistency before deeper metabolic correction begins.',
  ...
  },
  {
    ...
    bannerImg: '/pathways/Pathways%20Small%20Banner%202.webp',
    bannerHeading: 'Who Is Prescribed The REBUILD Pathway?',
    bannerBody: 'The REBUILD pathway is prescribed to clients who are looking to address underlying metabolic and gut imbalances through structured, measurable, and sustained intervention.',
    bannerOverlay: 'rgba(1,62,55,0.47)',
  },
  {
    id: 'sustain',
    ...
    bannerImg: '/pathways/Pathways%20Small%20Banner%203.webp',
    bannerHeading: 'Who Is Prescribed The SUSTAIN Pathway?',
    bannerBody: "The SUSTAIN pathway becomes a way for clients to inculcate the good habits they've learned in a sustained and integrated way into everyday life.",
      ...
      <div style={{ padding: 'clamp(32px,3.13vw,60px) clamp(16px,6.25vw,120px)' }}>
        ...
        >
          ...
          <div
            ...
            style={{ position: 'relative', zIndex: 1, padding: 'clamp(24px,4.17vw,80px) clamp(20px,4.17vw,80px)', gap: 'clamp(20px,3.13vw,60px)' }}
          >
            {/* Left — heading + body */}
            <div style={{ flex: 1 }}>
              <h3
            ...
            <div className="shrink-0">
              <a
                href="/assessment"
                onClick={() => trackEvent('cta_click', { location: 'pathways_metabolic_phase_cta', label: 'Start Assessment' })}
