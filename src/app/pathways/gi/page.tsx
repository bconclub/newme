...
const PHASES = [
  {
    id: 'core',
    tag: 'GI Core',
    duration: '1-Month Gut Reset Phase',
    badge: 'MOST COMMON',
    heading: 'Find the answer, not just manage the symptoms.',
    body: 'A structured elimination plan, a guided reintroduction protocol and daily coaching — so you know exactly what your body tolerates and why. GI Core is a medically overseen reset that identifies your triggers with precision rather than guesswork.',
    who: 'IBS, GERD, gastritis, acid reflux, food sensitivities, bloating and unexplained gut reactions.',
    ...
    bullets: [
      ...
      'Personalised elimination plan followed by a structured reintroduction, so your triggers are identified with precision',
    ...
    price: '$300 / month',
    priceNote: '1-month phase · $10 / day',
    accent: '#FEF272',
  },
  {
    id: 'advanced',
    tag: 'GI Advanced',
    duration: '1-Month Clinical GI Phase',
    badge: 'MOST INTENSIVE',
    heading: "Dr. Pal's most clinically intensive gut phase.",
    body: "Direct supervision, weekly therapist sessions and a full clinical team working your case from day one. GI Advanced is for Crohn's, Ulcerative Colitis, complex IBD presentations, or gut symptoms that haven't responded to standard care.",
    who: "Crohn's disease, Ulcerative Colitis, IBD, or complex gut conditions with long history.",
    tags: ['Direct clinical supervision', 'Weekly therapist sessions', 'Full team on your case'],
    bullets: [
      'Direct oversight from Dr. Pal\'s clinical team throughout the full phase',
      'Weekly 1:1 virtual sessions with a gut-specialist therapist',
      'Daily GI coach support with personalised dietary adjustments',
      'Medical-grade symptom tracking with documented clinical notes',
      'Specialist supplements prescribed specifically for your condition and phase',
      'Physiotherapist screening, Dr. Pal live sessions and full Virtual Gym access',
    ],
    price: '$600 / month',
    priceNote: '1-month phase · $20 / day',
    accent: '#FEF272',
  },
]
    ...
    <main style={{ background: '#013E37', color: '#fff', overflowX: 'hidden' }}>
      ...
      <section style={{ position: 'relative', zIndex: 1, paddingTop: 'clamp(110px,9.5vw,150px)', paddingBottom: 'clamp(40px,3.13vw,60px)', paddingLeft: 'clamp(20px,7.29vw,140px)', paddingRight: 'clamp(20px,7.29vw,140px)' }}>
        ...
        <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }}
          ...
          <span className="font-[family-name:var(--font-bricolage)]" style={{ fontSize: 13, fontWeight: 300, color: '#fff' }}>GastroIntestinal Care Pathway</span>
        </motion.div>
        ...
        <motion.p initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.55, ease: EASE, delay: 0.2 }}
          ...
          The GastroIntestinal Care Pathway contains two phases — GI Core and GI Advanced. Your assessment determines which phase matches your condition and history.
        </motion.p>
      </section>
