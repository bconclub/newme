    ...
    <>
      ...
      <main style={{ background: '#fff' }}>
        ...
        <section style={{ maxWidth: 800, margin: '0 auto', padding: 'clamp(40px,calc(72/1920*100vw),72px) clamp(20px,calc(40/1920*100vw),40px) clamp(60px,calc(100/1920*100vw),100px)' }}>
          ...
          <P>
            At NewME, we offer a range of programs designed to help users build healthy habits and sustainable lifestyle changes, and to empower users with tools, strategies and guidance to improve overall wellness. We adopt a practical, holistic, and evidence-based approach to design lifestyle changes to manage metabolic disorders and to address certain health concerns.
          </P>
          <P>
            Each Program and Service offering is tailored to suit a user&apos;s unique needs and focuses on areas such as nutrition, fitness, stress management and habit formation to help users achieve sustainable lifestyle changes. Each Program and Service combines personalized coaching, and group sessions, and helps set achievable goals that are tailored to individual needs. Programs may be fully customized to align with a user&apos;s schedule. This personalized pathway ensures that the approach resonates with each user&apos;s specific requirements maximizing effectiveness and accountability.
          </P>
          <P>NewME&apos;s dedicated team of virtual health coaches may serve as health educators, accountability partners, and self-care advocates for users. They help empower users through education, support, and actionable guidance, helping them navigate their health journey and achieve measurable results.</P>
          ...
          <Ul>
            ...
            <Li><strong>&ldquo;User&rdquo;</strong> refers to any individual who registers for, or accesses, or utilizes the services provided by NewME and/or enrolls in any of the Program(s) offered by NewME. By engaging as a user, a user agrees to abide by NewME&apos;s Terms, Community Guidelines, and any additional policies associated with the Services and Program(s).</Li>
            <Li><strong>&ldquo;Program&rdquo;</strong> refers to the specific health and wellness plan selected by the user from NewME&apos;s portfolio of offerings. Programs provided by NewME are intended as lifestyle management plans and are <strong>NOT</strong> substitutes for medical treatment or professional healthcare services. NewME does <strong>NOT</strong> diagnose, treat, or cure any medical condition. Users must consult their physician / healthcare provider before starting any Program.</Li>
            <Li><strong>&ldquo;Services&rdquo;</strong> refers to the collective offerings provided by NewME, including but not limited to personalized coaching, health education, tailored program design, virtual support, and any additional guidance or resources offered as part of any of NewME&apos;s Programs and Services. Services provided by NewME are intended as lifestyle management plans and are <strong>NOT</strong> substitutes for medical treatment or professional healthcare services. NewME does <strong>NOT</strong> diagnose, treat, or cure any medical condition. Users must consult their physician / healthcare provider before starting any Service.</Li>
          </Ul>

          <SectionHeading n={4}>Nature of NewME&apos;s Offerings</SectionHeading>
          <SubHeading>Acknowledgement of Scope</SubHeading>
          <P>The user acknowledges that while NewME or its agents may include general physicians or healthcare providers, or medical practitioners, their role is strictly limited to providing lifestyle management services under the Program or Service. The user acknowledges and agrees that participation in the Program <strong>does not establish any physician-patient relationship between the user and NewME.</strong></P>

          <SubHeading>No Medical Advice</SubHeading>
          <P>The user expressly acknowledges and agrees that NewME and its agents <strong>do not provide medical advice</strong> and are <strong>not a substitute</strong> for professional medical diagnosis, treatment or examination. Before participating in any Program, Service, activity, exercise, diet, or use of any product, program, workout, exercise or treatments discussed in the Program or Service, the user must consult with a licensed physician. NewME provides fitness and wellness programs and does <strong>NOT</strong> offer medical diagnoses, treatment, or cure for any medical condition. All Programs and Services are designed to support general wellness, fitness and lifestyle improvement. Your engagement with NewME does not establish a patient-physician relationship. If you are experiencing a medical emergency, please contact your physician or healthcare provider or local emergency services at the earliest.</P>

          <SubHeading>Participant Responsibility</SubHeading>
          <P>The user acknowledges and agrees that any reliance on the advice, opinions, ideas and suggestions of any person associated with NewME is at their <strong>sole discretion and risk.</strong> Users are responsible to consult with and follow up with their physicians or other qualified healthcare providers or medical professionals regarding any health issues, concerns, or medical conditions that arise before, during or after participation in the Program.</P>

          <SubHeading>Service Limitation</SubHeading>
          <Ul>
            <Li>The user acknowledges and agrees that Programs and Services offered by NewME are strictly <strong>limited to lifestyle management and related guidance.</strong> NewME and its parties are under <strong>no obligation</strong> to diagnose, treat, or counsel users regarding any medical or health conditions discovered, evaluated, or discussed during the Program.</Li>
            <Li>The user acknowledges and agrees that the services provided by NewME and/or its agents, including but not limited to healthcare professionals, dieticians, fitness coaches, and other professionals, under the Program or Service are strictly limited to lifestyle management and related guidance.</Li>
            <Li>The user expressly agrees that no services or advice beyond the scope of lifestyle management services shall be provided by NewME and/or its agents, and no such expectation shall be held towards NewME.</Li>
            <Li>If a user requires assistance in finding healthcare professionals, NewME may refer them to certain doctors or healthcare professionals, whom they may choose to consult at their sole discretion. NewME assumes no liability for any advice, treatment, or services provided by such doctors or healthcare professionals.</Li>
          </Ul>
          <P><strong>No warranty for the lifestyle management services:</strong> The user agrees that NewME and its agents do not warrant the accuracy, completeness, or adequacy of the lifestyle management services for any medical or treatment-related purposes.</P>
          <P>By agreeing to these Terms and Conditions, you indicate your awareness of this clause and its application.</P>
          ...
          <SectionHeading n="5b">Privacy and Confidentiality</SectionHeading>
          <SubHeading>Data Usage</SubHeading>
          <P>Any personal and health information a user provides will be used solely for Program / Service purposes and kept confidential in accordance with NewME&apos;s Privacy Policy.</P>

          <SubHeading>Group Communication Limits</SubHeading>
          <P>Features of the Programs and Services include but are not limited to group video call discussions, online training sessions, interactive forums, and discussion groups (&ldquo;Interactive Areas&rdquo;), where users may interact with others. While NewME strives to maintain confidentiality, NewME cannot guarantee it in Interactive Areas. Users are advised and encouraged to avoid disclosing personal information or sensitive health information in Interactive Areas. Any such information voluntarily disclosed by the user in the Interactive Areas shall be the user&apos;s sole responsibility. NewME shall not be held liable for any consequences arising from such disclosures.</P>
          ...
          <SectionHeading n={6}>Payments and Fees</SectionHeading>
          <Ul>
          ...
          <SectionHeading n={7}>Refunds, Non-transferability of Participation, Program Termination</SectionHeading>
          ...
          <P>Participation and enrollment in NewME&apos;s Programs and Services are non-transferable. Regardless of the reason and circumstances, when a user enrolls in a Program or Service, such a Program or Service cannot be continued by another individual if the user wishes to terminate or opt out of the Program.</P>
          ...
          <SectionHeading n={12}>No Warranties</SectionHeading>
          ...
          <SectionHeading n={13}>Consistency and Outcomes</SectionHeading>
          ...
          <SectionHeading n={15}>Governing Law and Dispute Resolution</SectionHeading>
          ...
          <P>The user and NewME agree to resolve any disputes that may emerge from their engagement in good faith. If the dispute cannot be resolved within thirty (30) days, both the Parties agree to submit to resolve the dispute through mediation. The mediation shall be conducted in Clark County, Nevada, and the mediator shall be mutually agreed upon by the parties. Each party shall bear its own costs and expenses associated with the mediation process.</P>
          <P>If the dispute is not resolved through mediation, all and any disputes, legal action or proceeding arising under or in connection with these Terms shall be subject to the exclusive jurisdiction of the courts of Clark County, Nevada.</P>

          <SectionHeading n={16}>International Use and Compliance</SectionHeading>
          ...
          <SectionHeading n={17}>Survival of Terms upon Termination</SectionHeading>
          <P>The user and NewME agree that the provision of the terms that are intended to survive termination in order to fulfill their intent and purpose will remain in full force and effect. These terms shall include but is not limited to:</P>
          <Ul>
          ...
          <SectionHeading n={18}>Electronic Communication and Consent</SectionHeading>
          <Ul>
          ...
          <SectionHeading n={19}>Miscellaneous</SectionHeading>
          <SubHeading>Amendment</SubHeading>
          <P>NewME reserves the right to modify these terms and conditions from time to time. All modifications and changes to the terms and conditions shall be communicated to the Participant through NewME&apos;s official website and mobile app. If there are any material modifications to the terms and conditions, the advance notice of the same shall be provided through our website and mobile app, and via email, where feasible. Unless otherwise required by law, modifications will not be applied retrospectively.</P>
          ...
          <Ul>
            <Li>NewME&apos;s communication with the user via email, mail, or notices displayed through the services constitutes acceptable notice under this Terms. The user is responsible to ensure that their contact information is up to date.</Li>
            <Li>NewME shall not be held responsible for any failure on the user&apos;s part to receive notice, including instances where emails are filtered by the email security system or where the user has not updated your contact information.</Li>
            <Li>All the notices sent via email or mail shall be deemed received after forty-eight (48) hours after being sent.</Li>
          </Ul>

          <P style={{ marginTop: 24, fontStyle: 'italic' }}>By participating in the Program, users acknowledge that they have read, understood, agreed to these Terms and Conditions. If a user has any questions, they may contact NewME before proceeding further.</P>
          ...
          <div style={{ marginTop: 48 }}>
            ...
            <Ul>
              ...
              <Li>You urge you to ensure that your actions contribute positively to the community.</Li>
            </Ul>
            ...
            <P>By participating in NewME Program, you agree to uphold to these Community Guidelines and contribute to a positive and supportive environment for everyone. Thank you for being a valued member of the Community.</P>
            <P>While we strive to monitor violations of these Community Guidelines, we cannot guarantee that all Participants will comply with such Guidelines at all times. If you believe or suspect that any other participant is violating the Community Guidelines, kindly report it to our support team at NewME.</P>
          </div>
