...
export const PW: Record<string, any> = {
  ...
  Rebuild: {
    ...
    bullets: [
      ...
      "BiWeekly virtual health education sessions with Dr. Pal and his team of doctors",
      "Unlimited fitness sessions. Login anytime, anywhere. 180+ live virtual sessions per week across Yoga, Strength, Zumba and Tabata.",
    ],
  ...
  GI_Advanced: {
    ...
    bullets: [
      "Clinical Oversight from Dr. Pal",
      "Initial Senior Doctor Review & Consultation from Dr. Pal's Team",
      "Senior GI Dietitian Foundation Call & Personalized Gut Health Roadmap",
      "Weekly Senior GI Coach Calls, Daily Check-ins & Diet Review",
      "Personalized Elimination Diet with Strategic Food Reintroduction",
      "Daily Symptom Tracking & Dietary Corrections",
      "Supplement Guidance, When Appropriate",
      "2 Mental Wellness Sessions per Month",
      "2 Mindfulness-Based Stress Reduction (MBSR) Sessions per Month with a Gut-Brain Specialist",
      "Physiotherapy Screening & Exercise Guidance",
      "Monthly Dietitian-Led Nutrition Education Sessions",
      "BiWeekly Live Health Education Sessions with Dr. Pal",
      "Monthly Mental Wellness & Physiotherapy Group Session",
      "Access to NewME Virtual Gym (180+ Live Sessions per Week)",
    ],
